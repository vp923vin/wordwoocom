...
//practice filter Hooks

//add_filter("the_title", "wp_filter_title");

	function wp_filter_title($title){
		return "wp_" .$title;
	}


//add_filter("the_content", "wp_filter_content");
	function wp_filter_content($content){
		return "content new " . $content . "ends here";
	}
